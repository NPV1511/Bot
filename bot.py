...
# ================== ENV CONFIG ==================
TOKEN = os.getenv("TOKEN")  # 👈 SET TRONG RAILWAY
GUILD_ID = int(os.getenv("GUILD_ID", "0"))  # 👈 SET TRONG RAILWAY
...
if not TOKEN or not GUILD_ID:
    raise RuntimeError("❌ Thiếu TOKEN hoặc GUILD_ID trong Environment Variables")
